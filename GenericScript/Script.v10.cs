...
namespace Mohid
{
   ...
   public class ScriptV10 : BCIMohidSim
   {
      #region DATA
      ...
      public override bool AfterInitialization(object data)
      {
         ...
         catch (Exception ex)
         {
            ...
            exception = new Exception("ScriptV10.AfterInitialization", ex);
            return false;
         }
      }
      ...
      public override bool OnSimStart(object data)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.OnSimStart", ex);
            return false;
         }
      }
      ...
      public override bool OnSimEnd(object data)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.OnSimEnd", ex);
            return false;
         }
      }
      ...
      public override bool OnEnd(object data)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.OnEnd", ex);
            return false;
         }
      }
      ...
      protected void LoadGlobalConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.LoadGlobalConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadToolsConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.LoadToolsConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadTasksConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.LoadTasksConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadBasinGlueConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.LoadBasinGlueConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadMeteoTaskConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.LoadMeteoTaskConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void SetupRun()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.SetupRun", ex);
            throw exception;
         }
      }
      ...
      protected void SetupTemplates()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.SetupTemplates", ex);
            throw exception;
         }
      }
      ...
      protected void CopyIniFiles()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.CopyIniFiles", ex);
            throw exception;
         }
      }
      ...
      protected void CreatePracticesIDHDFFile()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.CreatePracticesIDHDFFile", ex);
            throw exception;
         }
      }
      ...
      protected bool MeteoFileExists()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.MeteoFileExists", ex);
            throw exception;
         }
      }
      ...
      protected void GlueFiles(List<FileName> files_to_glue, FileName output, bool is_3d)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.GlueFiles", ex);
            throw exception;
         }
      }
      ...
      protected void InterpolateFile(FileName input, FileName father_grid, FilePath output_path, FileName model_grid, FileName template_file, FileName action_file)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.InterpolateFile", ex);
            throw exception;
         }
      }
      ...
      protected void FillMatrix(FileName model_grid, FileName output_file, DateTime start, DateTime end, FileName template_file, FileName action_file)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.FillMatrix", ex);
            throw exception;
         }
      }
      ...
      protected void JoinTimeseriesByFolder(FileName output, string filter, List<FilePath> folders_to_search, bool search_sub_folders = true, bool overwrite = true, TimeUnits tu = TimeUnits.SECONDS)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.JoinTimeseriesByFolder", ex);
            throw exception;
         }
      }
      ...
      protected DateTime DefineCorrectStartDateForMeteoFilesSearch(DateTime run_start)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.DefineCorrectStartDateForMeteoFilesSearch", ex);
            throw exception;
         }
      }
      ...
      protected void ClearFolder(FilePath folderToClean)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.ClearFolder", ex);
            throw exception;
         }
      }
                              ...
                              System.IO.SearchOption so = System.IO.SearchOption.TopDirectoryOnly)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV10.FindFiles", ex);
            throw exception;
         }
      }
      ...
      protected void GlueBasinEVTPFile()
      {
         ...
         catch (Exception ex)
         {
            ...
            exception = new Exception("ScriptV10.GlueBasinEVTPFile", ex);
            throw exception;
         }
      }

...
namespace Mohid
{
   public class ScriptV4 : BCIMohidSim
   {
      #region DATA
      ...
      public override bool AfterInitialization(object data)
      {
         ...
         catch (Exception ex)
         {
            ...
            exception = new Exception("ScriptV4.AfterInitialization", ex);
            return false;
         }
      }
      ...
      public override bool OnSimStart(object data)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.OnSimStart", ex);
            return false;
         }
      }
      ...
      public override bool OnSimEnd(object data)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.OnSimEnd", ex);
            return false;
         }
      }
      ...
      public override bool OnEnd(object data)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.OnEnd", ex);
            return false;
         }
      }
      ...
      protected void LoadGlobalConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.LoadGlobalConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadToolsConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.LoadToolsConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadTasksConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.LoadTasksConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void LoadMeteoTaskConfiguration()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.LoadMeteoTaskConfiguration", ex);
            throw exception;
         }
      }
      ...
      protected void SetupRun()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.SetupRun", ex);
            throw exception;
         }
      }
      ...
      protected void SetupTemplates()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.SetupTemplates", ex);
            throw exception;
         }
      }
      ...
      protected void CopyIniFiles()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.CopyIniFiles", ex);
            throw exception;
         }
      }
      ...
      protected void CreatePracticesIDHDFFile()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.CreatePracticesIDHDFFile", ex);
            throw exception;
         }
      }
      ...
      protected bool MeteoFileExists()
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.MeteoFileExists", ex);
            throw exception;
         }
      }
      ...
      protected void GlueFiles(List<FileName> files_to_glue, FileName output, bool is_3d)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.GlueFiles", ex);
            throw exception;
         }
      }
      ...
      protected void InterpolateFile(FileName input, FileName father_grid, FilePath output_path, FileName model_grid, FileName template_file, FileName action_file)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.InterpolateFile", ex);
            throw exception;
         }
      }
      ...
      protected void FillMatrix(FileName model_grid, FileName output_file, DateTime start, DateTime end, FileName template_file, FileName action_file)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.FillMatrix", ex);
            throw exception;
         }
      }
      ...
      protected void JoinTimeseriesByFolder(FileName output, string filter, List<FilePath> folders_to_search, bool search_sub_folders = true, bool overwrite = true, TimeUnits tu = TimeUnits.SECONDS)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.JoinTimeseriesByFolder", ex);
            throw exception;
         }
      }
      ...
      protected DateTime DefineCorrectStartDateForMeteoFilesSearch(DateTime run_start)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.DefineCorrectStartDateForMeteoFilesSearch", ex);
            throw exception;
         }
      }
      ...
      protected void ClearFolder(FilePath folderToClean)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.ClearFolder", ex);
            throw exception;
         }
      }
                              ...
                              System.IO.SearchOption so = System.IO.SearchOption.TopDirectoryOnly)
      {
         ...
         {
            exception_raised = true;
            exception = new Exception("ScriptV4.FindFiles", ex);
            throw exception;
         }
      }
